<!--
 * @Author: your name
 * @Date: 2021-06-15 09:16:09
 * @LastEditTime: 2021-06-15 10:37:22
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /hx/packages/tbSubmenu/main.vue
-->
<template>
...
export default {
  ...
  mounted() {
    this.$on('menu-item-select', (name) => {
      ...
      this.dispatch('BMenu', 'menu-item-select', name)
      return true
    })
    this.$on('update-active-name', (status) => {
      if (findComponentUpward(this, 'BSubmenu')) {
        this.dispatch('BSubmenu', 'update-active-name', status)
      }
