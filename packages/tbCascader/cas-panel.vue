<!--
 * @Author: your name
 * @Date: 2021-06-18 13:11:52
 * @LastEditTime: 2021-06-18 13:15:48
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /hx/packages/tbCascader/cas-panel.vue
-->
<template>
  <div class="tb-cascader-panel">
...
import { findComponentUpward, findComponentDownward } from '../utils/utils'
...
export default {
  ...
  methods: {
    ...
    handleTriggerItem(item, fromInit = false, fromUser = false) {
      ...
      const cascade = findComponentUpward(this, 'tbCascader')
      ...
      if (item.loading !== undefined && !item.children.length) {
        if (this.changeOnSelect) {
          ...
          this.dispatch('tbCascader', 'result-change', {
            lastValue: false,
