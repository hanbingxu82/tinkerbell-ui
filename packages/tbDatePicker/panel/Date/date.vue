<!--
 * @Author: your name
 * @Date: 2021-06-17 14:45:27
 * @LastEditTime: 2021-06-17 15:18:35
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /hx/packages/tbDatePicker/panel/Date/date.vue
-->
<template>
    ...
    <div :class="[prefixCls + '-body']">
      <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                <span
                    ...
                    @click="changeYear(-1)"><i class="iconfont icon-arrow-left-bold"></i></span>
        <span
            v-if="pickerTable === 'date-table'"
            :class="iconBtnCls('prev')"
            @click="changeMonth(-1)"
            v-show="currentView === 'date'"><i class="iconfont icon-arrow-left-bold"></i></span>
        <date-panel-label
        ...
        <span
            ...
            @click="changeYear(+1)"><i class="iconfont icon-arrow-right-bold"></i></span>
        <span
            v-if="pickerTable === 'date-table'"
            :class="iconBtnCls('next')"
            @click="changeMonth(+1)"
            v-show="currentView === 'date'"><i class="iconfont icon-arrow-right-bold"></i></span>
      </div>
...
const prefixCls = 'tb-picker-panel'
const datePrefixCls = 'tb-date-picker'
