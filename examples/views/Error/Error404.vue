<!--
 * @Author: your name
 * @Date: 2021-07-05 08:29:05
 * @LastEditTime: 2021-07-05 08:49:18
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /hx/examples/views/Error/Error404.vue
-->
<template>
  <div class="tb-result tb-result-404" style="background: none;">
    <div class="tb-result-icon tb-result-image">
    ...
    <div class="tb-result-title">404</div>
    <div class="tb-result-subtitle">抱歉，你访问的页面不存在。</div>
    <div class="tb-result-extra">
      <router-link to="/">
        <tb-button type="primary">返回首页</tb-button>
      </router-link>
    </div>
  </div>
</template>
